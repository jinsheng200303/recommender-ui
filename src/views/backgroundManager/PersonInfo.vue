<template>
    <el-container direction="vertical">
        ...
        <img src="../../assets/dls.png" alt="" class="image">
        <div class="userInfo">
            ...
            <ul class="info-list">
                ...
                <li class="info-list-item">
                    <span class="list-item-label">政治面貌:</span>
...
import userinfoedit from '@/views/user/userinfoedit.vue';
...
export default {
    ...
    computed: {
        getUserRole(){
            if(this.politics == 10){
                return "共 青 团 员";
            }else if(this.politics == 20){
                return "中 共 党 员"
            }
            else if(this.politics == 30){
                return "民 主 党 派"
            }else{
                return "群 众"
            }
